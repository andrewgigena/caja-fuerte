# 1 "/home/shadows/caja_fuerte/caja_fuerte.ino"
# 1 "/home/shadows/caja_fuerte/caja_fuerte.ino"
// ================== Librerias ================== 
...
# 8 "/home/shadows/caja_fuerte/caja_fuerte.ino" 2
# 9 "/home/shadows/caja_fuerte/caja_fuerte.ino" 2
# 10 "/home/shadows/caja_fuerte/caja_fuerte.ino" 2
...
void setup() {
    ...
    pinMode(PIN_LED_1, 0x1);
    pinMode(PIN_LED_2, 0x1);
    pinMode(PIN_LED_3, 0x1);
    pinMode(PIN_LED_4, 0x1);
    pinMode(PIN_LED_5, 0x1);
    pinMode(PIN_LED_PUERTA, 0x1);
    pinMode(PIN_LED_ALARMA, 0x1);
    pinMode(PIN_RELE_ALARMA, 0x1);
    pinMode(PIN_RELE_PUERTA, 0x1);
}
...
# 209 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                     (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 209 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                     "# Modo > Alarma sonando"
# 209 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                     ); &__c[0];}))
# 209 "/home/shadows/caja_fuerte/caja_fuerte.ino"
        ...
        controlLeds(7, true);
        digitalWrite(PIN_RELE_ALARMA, 0x1);
        while (controlAlarma == false) {
            controlAlarma = modoAlarma();
        }
    } else {
        controlLeds(7, false);
        digitalWrite(PIN_RELE_ALARMA, 0x0);
    }
    ...
    if (opcPrimerInicio == true) {
        ...
        Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 230 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                      (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 230 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                      "# Modo > Nuevo pin"
# 230 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                      ); &__c[0];}))
# 230 "/home/shadows/caja_fuerte/caja_fuerte.ino"
        ...
        // Muestra por serial y en pantalla el modo
        Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 243 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                      (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 243 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                      "# Modo > Ingreso de pin"
# 243 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                      ); &__c[0];}))
# 243 "/home/shadows/caja_fuerte/caja_fuerte.ino"
    ...
    if (controlPinIngresado == true) {
        ...
        if (opcEstadoPin == true) {
            // Muestra por serial y en pantalla el modo
           Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 262 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 262 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         "# Modo > Caja Abierta"
# 262 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         ); &__c[0];}))
# 262 "/home/shadows/caja_fuerte/caja_fuerte.ino"
            ...
            digitalWrite(PIN_RELE_PUERTA, 0x1);
            while (controlCajaAbierta == false) {
                controlCajaAbierta = modoCajaAbierta();
            }
        } else {
            digitalWrite(PIN_RELE_PUERTA, 0x0);
        }
    }
}
...
void textoPreInicio() {
   Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 291 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 291 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                 "Bienvenido a la consola de la Caja Fuerte.\n"
# 291 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                 ); &__c[0];}))
# 291 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                 )));
   Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 292 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 292 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                 "Presione cero para continuar.\n"
# 292 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                 ); &__c[0];}))
# 292 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                 )));
...
void textoInicio() {
   Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 301 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                 (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 301 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                 "# Modo > Inicio de caja fuerte"
# 301 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                 ); &__c[0];}))
# 301 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                 )));
...
void controlLeds(byte leds, bool estado) {
    switch (leds) {
        case 0:
            digitalWrite(PIN_LED_1, 0x0); digitalWrite(PIN_LED_2, 0x0); digitalWrite(PIN_LED_3, 0x0); digitalWrite(PIN_LED_4, 0x0); digitalWrite(PIN_LED_5, 0x0);
            break;

        case 1:
            digitalWrite(PIN_LED_1, 0x1); digitalWrite(PIN_LED_2, 0x0); digitalWrite(PIN_LED_3, 0x0); digitalWrite(PIN_LED_4, 0x0); digitalWrite(PIN_LED_5, 0x0);
            break;

        case 2:
            digitalWrite(PIN_LED_1, 0x1); digitalWrite(PIN_LED_2, 0x1); digitalWrite(PIN_LED_3, 0x0); digitalWrite(PIN_LED_4, 0x0); digitalWrite(PIN_LED_5, 0x0);
            break;

        case 3:
            digitalWrite(PIN_LED_1, 0x1); digitalWrite(PIN_LED_2, 0x1); digitalWrite(PIN_LED_3, 0x1); digitalWrite(PIN_LED_4, 0x0); digitalWrite(PIN_LED_5, 0x0);
            break;

        case 4:
            digitalWrite(PIN_LED_1, 0x1); digitalWrite(PIN_LED_2, 0x1); digitalWrite(PIN_LED_3, 0x1); digitalWrite(PIN_LED_4, 0x1); digitalWrite(PIN_LED_5, 0x0);
            break;

        case 5:
            digitalWrite(PIN_LED_1, 0x1); digitalWrite(PIN_LED_2, 0x1); digitalWrite(PIN_LED_3, 0x1); digitalWrite(PIN_LED_4, 0x1); digitalWrite(PIN_LED_5, 0x1);
            break;

        case 6:
            if (estado == true) {
                digitalWrite(PIN_LED_PUERTA, 0x1); digitalWrite(PIN_LED_ALARMA, 0x0);
                controlLeds(5, true);
            } else {
                digitalWrite(PIN_LED_PUERTA, 0x0);
            }
            break;

        case 7:
            if (estado == true) {
                digitalWrite(PIN_LED_PUERTA, 0x0); digitalWrite(PIN_LED_ALARMA, 0x1);
                controlLeds(0, true);
            } else {
                digitalWrite(PIN_LED_ALARMA, 0x0);
            }
...
# 433 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 433 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                "Tecla: "
# 433 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                ); &__c[0];}))
# 433 "/home/shadows/caja_fuerte/caja_fuerte.ino"
    ...
    Serial.write(texto);
    Serial.print((reinterpret_cast<const __FlashStringHelper *>(
# 435 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 435 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                " - "
# 435 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                ); &__c[0];}))
# 435 "/home/shadows/caja_fuerte/caja_fuerte.ino"
...
bool verificarPin() {
    ...
    for (int j = 0; j <= 5; j++) {
        ...
        if (pinMem != pinEEP) {
           Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 448 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 448 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         "Pin incorrecto"
# 448 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         ); &__c[0];}))
# 448 "/home/shadows/caja_fuerte/caja_fuerte.ino"
    ...
    Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 453 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                  (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 453 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                  "Pin correcto"
# 453 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                  ); &__c[0];}))
# 453 "/home/shadows/caja_fuerte/caja_fuerte.ino"
...
bool modoComienzo() {
    ...
    if (key != NO_KEY){
        if (debugmode == false) {
            ...
            if (debugcode == 386 ) {
               Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 680 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                             (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 680 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                             "# Modo > Programador activado"
# 680 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                             ); &__c[0];}))
# 680 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                             )));
...
void modoProgramador (byte debugcode) {
    switch (debugcode) {
        case 101:
           Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 747 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 747 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         "# Comando > Primer inicio activado"
# 747 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         ); &__c[0];}))
# 747 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         )));
        ...
        case 102:
           Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 753 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 753 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         "# Comando > Primer inicio desactivado"
# 753 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         ); &__c[0];}))
# 753 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         )));
        ...
        case 103:
           Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 759 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 759 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         "# Comando > Alarma activada"
# 759 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         ); &__c[0];}))
# 759 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         )));
        ...
        case 104:
           Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 766 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 766 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         "# Comando > Alarma desactivada"
# 766 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         ); &__c[0];}))
# 766 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         )));
        ...
        case 105:
           Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 773 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 773 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         "# Comando > Caja abierta"
# 773 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         ); &__c[0];}))
# 773 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         )));
        ...
        case 106:
           Serial.println((reinterpret_cast<const __FlashStringHelper *>(
# 779 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         (__extension__({static const char __c[] __attribute__((__progmem__)) = (
# 779 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         "# Comando > Caja cerrada"
# 779 "/home/shadows/caja_fuerte/caja_fuerte.ino" 3
                         ); &__c[0];}))
# 779 "/home/shadows/caja_fuerte/caja_fuerte.ino"
                         )));
